        ...
        <div className='proj'>
            ...
            <div className="projCont">
                <div className="final">
                    ...
                    <a href="https://hemantjayas.github.io/HealthKart/"><button>Preview</button></a>
                        <a href="https://github.com/hemantjayas/HealthKart"><button>Code</button></a>
                    </div>
                </div>
                <div className="final">
...
Pulse Pharmacy is a leading Online Pharmacy in India that offers prescription medicines and OTC products all over India. Pulse Pharmacy is to ensure health to all the individuals.</p>
                    ...
                    <div className='buttons'>
                    <a href="https://hemantjayas.github.io/PulsePlus/"><button>Preview</button></a>
                        <a href="https://github.com/hemantjayas/PulsePlus"><button>Code</button></a> 
                    </div>
                </div>
            </div>
