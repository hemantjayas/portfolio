      ...
      <div className="projCont">
        <div className="final">
          ...
          <div>
            ...
            <p>
              HealthKart.com is India's largest online health and fitness store
        ...
        <div className="final">
          ...
          <p>
            Pulse Pharmacy is a leading Online Pharmacy in India that offers
            prescription medicines and OTC products all over India. Pulse
            Pharmacy is to ensure health to all the individuals.
          </p>
          <h3>Tech Stack</h3>
